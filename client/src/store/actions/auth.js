...
export const uploadImage = (id, image) => async (dispatch) => {
  try {
    ...
    const url = "api/user/users/photo/" + id;
...
export const login = (username, password) => async (dispatch) => {
  try {
    const url = "api/user/users/login";
    const response = await fetch(url, {
      method: "POST",
...
export const facebookLogin = (e) => async (dispatch) => {
  try {
    ...
    const url = "api/user/users/login/facebook";
...
export const googleLogin =
  ...
  async (dispatch) => {
    try {
      ...
      const url = "api/user/users/login/google";
      const response = await fetch(url, options);
      const responseData = await response.json();
...
export const logout = () => async (dispatch) => {
  try {
    ...
    const url = "api/user/users/logout";
    localStorage.clear();
